...
pub struct Strings {
    ...
    pub profile_best: &'static str,
    pub profile_whatsapp: &'static str,
    pub profile_hint: &'static str,
    pub profile_audio_forced_hint: &'static str,
    ...
    pub status_whatsapp_needs_ffmpeg: &'static str,
...
pub static EN: Strings = Strings {
    ...
    profile_whatsapp: "Compatible · WhatsApp",
    profile_hint: "   (w/b or ←/→)",
    profile_audio_forced_hint: "   (WhatsApp → M4A)",
    quality_best: "Best",
    quality_worst: "Worst",
    audio_best: "Best",
    ...
    how_step2: "2. Pick Video/Audio, profile (Best or WhatsApp), and quality",
    ...
    settings_tip_file: "• File: ~/.config/ytd/config.toml",
    ...
    status_whatsapp_needs_ffmpeg: "WhatsApp profile needs ffmpeg (install ffmpeg and retry)",
...
pub static PT_BR: Strings = Strings {
    ...
    mode_video: "Vídeo",
    mode_audio: "Áudio",
    profile_best: "Melhor qualidade",
    profile_whatsapp: "Compatível · WhatsApp",
    profile_hint: "   (w/b ou ←/→)",
    profile_audio_forced_hint: "   (WhatsApp → M4A)",
    quality_best: "Melhor",
    quality_worst: "Pior",
    ...
    how_step2: "2. Escolha Vídeo/Áudio, perfil (Melhor ou WhatsApp) e qualidade",
    ...
    settings_tip_file: "• Arquivo: ~/.config/ytd/config.toml",
    ...
    status_whatsapp_needs_ffmpeg: "Perfil WhatsApp precisa de ffmpeg (instale e tente de novo)",
